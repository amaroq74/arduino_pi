...
const char * OutputCmndTopic[] = {"cmnd/test_switch3/out1", "cmnd/test_switch3/out2" };
const char * OutputStatTopic[] = {"stat/test_switch3/out1", "stat/test_switch3/out2" };
unsigned int OutputPin[]       = {12, 5, 4, 15};
unsigned int OutputMaxTime[]   = {3600000, 3600000, 3600000, 3600000}; // 1 Hours

// Analog Inputs
const unsigned int InputCount = 3;
const char * InputStatTopic[] = {"stat/test_switch2/button1", "stat/test_switch2/button2", "stat/test_switch2/button3"};
unsigned int InputPin[]       = {14, 10, 9};
